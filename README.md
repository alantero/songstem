...
* ```-j```. Allow to specify a number of parallel jobs. This will multiply by the same amount the RAM used so be careful! Default value is 6 (*This value depends on your computer number of cores*)
